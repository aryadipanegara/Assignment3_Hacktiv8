            ...
            >
              ...
              >
                <p className="text-white text-lg">
                  ...
                  interactive web experiences. I have a solid foundation in
                  HTML, CSS, JavaScript, and PHP, and I continuously strive to
                  expand my skills and stay up-to-date with the latest web
                  development trends. I enjoy collaborating with teams to bring
                  designs to life and optimize website performance. Let's work
                  together to build innovative and user-friendly web solutions
                  that make a positive impact!
                </p>
                <p className="text-white mt-4 text-lg">
                  Saya sangat antusias dalam Front-End dan selalu mencari
                  peluang untuk belajar dan berkembang. Selain itu, saya juga
                  sering melakukan street Fotografer di waktu luang saya.
                </p>
              </motion.div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <p className="text-white text-lg">
                    Untuk melihat resume saya, Anda dapat mengunduhnya di
                    [Tautan Resume].
                  </p>
                </div>
              </motion.div>
